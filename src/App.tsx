...
// В каждом описании явно указана цветность (чёрно-белое / монохром / палитра),
// чтобы это автоматически попадало в генерируемый промпт.
const photoStyleOptions: Record<string, string[]> = {
  'Fashion-фотография': [
    'Vogue — высокая мода, глянцевая эстетика, драматичное освещение, цветная фотография с насыщенными модными тонами',
    'Harper\'s Bazaar — элегантность, утончённость, художественная фотография, изысканная цветная или чёрно-белая подача',
    'Elle — современная мода, яркие цвета, динамичные позы, сочная цветная палитра',
    'Cosmopolitan — яркая гламурная эстетика, смелые позы, глянцевая цветная подача',
    'Marie Claire — естественная красота, мягкий свет, натуральная цветопередача',
    'L\'Officiel — французская элегантность, haute couture, утончённая цветная гамма',
    'Numéro — минимализм, чёрно-белая эстетика, графичность, строго монохромное изображение',
    'Dazed — альтернативная мода, креативность, экспериментальная цветопередача',
    'i-D — британская уличная мода, документальный подход, часто чёрно-белые кадры',
    'W Magazine — гламур, роскошь, драматичные портреты, богатая цветовая палитра',
  ],
  'Портрет': [
    'Annie Leibovitz — театральность, драматичный свет, знаменитости, насыщенная цветная фотография',
    'Peter Lindbergh — чёрно-белая классика, естественность, строго чёрно-белое изображение без цвета',
    'Richard Avedon — минимализм, выразительность, движение, чаще всего чёрно-белый портрет на светлом фоне',
    'Irving Penn — студийная классика, элегантность, приглушённая цветная гамма или чёрно-белый',
    'Helmut Newton — провокация, сильная женственность, контрастная чёрно-белая съёмка с элементами цвета',
    'Mario Testino — гламур, чувственность, цвет, тёплая цветная палитра',
    'Steven Meisel — концептуальность, мода, драма, выразительная цветная гамма',
    'Tim Walker — сказочность, сюрреализм, фантазия, яркий цветной мир',
    'Dan Winters — кинематографичность, портреты знаменитостей, глубокие цветные тона',
    'Platon — крупные планы, политические портреты, характер, преимущественно чёрно-белая съёмка',
  ],
  'Стрит-фото': [
    'Henri Cartier-Bresson — решающий момент, геометрия, классическая чёрно-белая уличная фотография',
    'Vivian Maier — повседневность, наблюдение, монохромные уличные кадры',
    'Garry Winogrand — энергия города, спонтанность, зернистая чёрно-белая съёмка',
    'Joel Meyerowitz — цветная уличная фотография, яркая насыщенная палитра',
    'Fan Ho — свет и тень, азиатская эстетика, контрастное чёрно-белое изображение',
    'Saul Leiter — цвет, отражения, абстракция, мягкие пастельные тона',
    'Daido Moriyama — зернистость, контраст, японский авангард, грубая чёрно-белая плёнка',
    'Alex Webb — сложный цвет, многослойность, плотная цветная гамма',
  ],
  'Свадебная фотография': [
    'Классический стиль — традиционные позы, элегантность, мягкая цветная гамма',
    'Репортажный стиль — естественные моменты, эмоции, живая цветопередача',
    'Fine Art — художественная эстетика, мягкий свет, воздушные пастельные тона',
    'Dark and Moody — тёмные тона, драматичность, приглушённая цветная гамма с глубокими тенями',
    'Bright and Airy — светлые тона, воздушность, светлая нежная палитра',
    'Vintage — винтажная эстетика, плёночные цвета, тёплые приглушённые тона',
    'Cinematic — кинематографичность, широкие планы, кинематографическая цветокоррекция',
    'Editorial — журнальный стиль, постановочные кадры, стильная цветная обработка',
  ],
  'Предметная съёмка': [
    'Минимализм — чистый фон, акцент на объекте, чистая цветопередача',
    'Lifestyle — объект в контексте использования, естественная цветная гамма',
    'Flat lay — вид сверху, композиция на плоскости, яркие чистые цвета',
    'Драматичный свет — контраст, тени, объём, глубокие насыщенные тона',
    'Bright & Clean — яркий свет, чистота, свежесть, светлая палитра',
    'Dark & Moody — тёмный фон, драматичность, приглушённые тёмные тона',
    'Vintage — винтажная эстетика, тёплые тона, плёночная цветопередача',
    'Luxury — роскошь, блеск, премиальность, богатая золотистая палитра',
  ],
  'Пейзаж': [
    'Ansel Adams — чёрно-белая классика, контраст, детализация, строго монохромное изображение',
    'Galen Rowell — цветная природа, драматичный свет, насыщенные цвета',
    'Marc Adamus — современная пейзажная фотография, цвет, богатая цветовая гамма',
    'Max Rive — эпические пейзажи, горы, звёзды, яркая цветная подача',
    'Peter Lik — яркие цвета, культовые места, насыщенная цветная гамма',
    'Sebastião Salgado — документальный подход, чёрно-белая фотография, мощный монохром',
  ],
  'Архитектурная съёмка': [
    'Минимализм — чистые линии, геометрия, сдержанная палитра, часто чёрно-белое изображение',
    'Драматичный — контраст, тени, объём, глубокая цветная гамма',
    'HDR — расширенный динамический диапазон, насыщенные цвета',
    'Чёрно-белый — графика, структура, строго монохромное изображение',
    'Золотой час — тёплый свет, длинные тени, золотисто-тёплые тона',
    'Синий час — холодные тона, городские огни, холодная сине-фиолетовая палитра',
    'Абстракция — детали, паттерны, формы, графичная подача',
  ],
  'Натюрморт': [
    'Классический — тёмный фон, драматичный свет, тёплая приглушённая гамма',
    'Голландский — фламандская эстетика, символизм, тёмная классическая палитра',
    'Современный — яркий свет, чистый фон, чистая цветопередача',
    'Минималистичный — минимум деталей, акцент на форме, сдержанная палитра',
    'Романтический — мягкий свет, цветы, нежность, пастельные тона',
    'Драматичный — контраст, тени, объём, глубокие тона',
  ],
  'Спортивная съёмка': [
    'Action — замороженное движение, резкость, динамичная цветная съёмка',
    'Эмоциональный — выражения лиц, страсть, живая цветопередача',
    'Кинематографичный — широкие планы, драма, кинематографический цвет',
    'Чёрно-белый — графика, контраст, монохромное изображение',
    'Документальный — репортаж, естественность, честная цветопередача',
    'Художественный — постановка, свет, композиция, авторская цветовая гамма',
  ],
  'Рекламная съёмка': [
    'Lifestyle — продукт в жизни, естественность, живая цветная гамма',
    'Студийный — чистый фон, акцент на продукте, безупречная цветопередача',
    'Эмоциональный — чувства, ассоциации, тёплая выразительная палитра',
    'Минималистичный — простота, акцент, чистая лаконичная палитра',
    'Премиальный — роскошь, качество, детали, богатая благородная гамма',
    'Динамичный — движение, энергия, контрастные насыщенные цвета',
  ],
};
...
const distanceOptions = [
  ...
  'Крупный план — объект расположен близко к камере, занимает 70-80% кадра, видны все детали лица или объекта, фон сильно размыт, акцент на выражении или форме',
  'Средне-крупный план — объект показан от головы до плеч, занимает 50-60% кадра, видны черты лица, выражение, верхняя часть тела, фон размыт',
...
const backgroundDescriptions: Record<string, string> = {
  ...
  'Звёздное небо': 'звёздное небо с яркими созвездиями, космической глубиной и ощущением бесконечности вселенной',
  'Северное сияние': 'магическое северное сияние с переливающимися зелёными и фиолетовыми оттенками, арктической атмосферой и природным чудом',
  'Грозовое небо': 'драматичное грозовое небо с тёмными тучами, вспышками молний и напряжённой атмосферой стихии',
  'Радуга': 'яркая радуга с семьёй цветов, оптимистичной атмосферой и ощущением чуда после дождя',
  'Лунный свет': 'мягкий лунный свет с серебристой палитрой, ночной романтикой и таинственной атмосферой',
  'Водопад': 'мощный водопад с падающей водой, брызгами и энергией природной стихии',
  'Океанские волны': 'динамичные океанские волны с морской энергией, солью и свободой водной стихии',
  'Снежные горы': 'заснеженные горные вершины с кристальной чистотой, зимней красотой и альпийской атмосферой',
  'Цветущие сады': 'цветущие сады с разнообразием красок, ароматом весны и романтической атмосферой',
  'Осенние листья': 'золотые осенние листья с тёплой палитрой, ностальгической атмосферой и красотой увядания',
  'Зимний лес': 'зимний лес с заснеженными деревьями, тишиной и сказочной атмосферой северной природы',
  'Весенние цветы': 'весенние цветы с нежными оттенками, свежестью и атмосферой пробуждения природы',
  'Летнее поле': 'летнее поле с бескрайним простором, тёплым солнцем и ощущением свободы',
  'Пустынные дюны': 'пустынные дюны с золотистым песком, волнообразными формами и атмосферой экзотики',
  'Тропический пляж': 'тропический пляж с белым песком, пальмами и лазурной водой, атмосферой рая',
  'Вулкан': 'действующий вулкан с лавой, огнём и мощной энергией земной стихии',
  'Каньон': 'глубокий каньон с отвесными скалами, геологической историей и монументальной красотой',
  'Пещера': 'таинственная пещера с сталактитами, приглушённым светом и атмосферой подземного мира',
  'Болото': 'атмосферное болото с туманом, мистической природой и ощущением древности',
  'Тундра': 'суровая тундра с минималистичным ландшафтом, холодным ветром и северной эстетикой',
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-green-500/20 p-5">
              <h2 className="text-lg font-semibold text-green-300 mb-4">🌅 Фон</h2>
              <div className="space-y-3">
                <div>
                  <label className="block text-xs text-gray-400 mb-1">Фон</label>
                  <SelectWithCustom
                    value={data.background}
                    onChange={(v: string) => handleChange('background', v)}
                    options={backgroundOptions}
                    placeholder="Выберите или введите свой вариант фона"
                  />
                </div>
              </div>
            </div>
